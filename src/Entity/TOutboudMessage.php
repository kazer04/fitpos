 ...
 * TOutboudMessage
 *
 * @ORM\Table(name="t_outboud_message")
 * @ORM\Entity
 */
class TOutboudMessage
{
    /**
     * @var string
     *
     * @ORM\Column(name="lg_OUTBOUND_MESSAGE_ID", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgOutboundMessageId;
    ...
    public function getLgOutboundMessageId(): ?string
    {
        return $this->lgOutboundMessageId;
    }
