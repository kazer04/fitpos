 ...
 * TJourSemaine
 *
 * @ORM\Table(name="t_jour_semaine", uniqueConstraints={@ORM\UniqueConstraint(name="lg_JOUR_SEMAINE_ID", columns={"lg_JOUR_SEMAINE_ID"})})
 * @ORM\Entity
 */
class TJourSemaine
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_JOUR_SEMAINE_ID", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgJourSemaineId;
    ...
    public function getLgJourSemaineId(): ?string
    {
        return $this->lgJourSemaineId;
    }
