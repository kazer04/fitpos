 ...
 * TTypeReglement
 *
 * @ORM\Table(name="t_type_reglement")
 * @ORM\Entity
 */
class TTypeReglement
{
    /**
     * @var string
     *
     * @ORM\Column(name="lg_TYPE_REGLEMENT_ID", type="string", length=40, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgTypeReglementId;
    ...
    public function getLgTypeReglementId(): ?string
    {
        return $this->lgTypeReglementId;
    }
