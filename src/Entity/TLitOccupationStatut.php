...
/**
 * TLitOccupationStatut
 *
 * @ORM\Table(name="t_lit_occupation_statut", uniqueConstraints={@ORM\UniqueConstraint(name="lg_LIT_OCCUPATION_STATUT_ID", columns={"lg_LIT_OCCUPATION_STATUT_ID"})}, indexes={@ORM\Index(name="lg_LIT_ID", columns={"lg_LIT_ID"}), @ORM\Index(name="lg_CUSTOMER_ID", columns={"lg_CUSTOMER_ID"})})
 * @ORM\Entity
 */
class TLitOccupationStatut
{
    /**
     * @var string
     *
     * @ORM\Column(name="lg_LIT_OCCUPATION_STATUT_ID", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgLitOccupationStatutId;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="dt_DATE", type="date", nullable=true)
     */
    private $dtDate;
    ...
    public function getLgLitOccupationStatutId(): ?string
    {
        return $this->lgLitOccupationStatutId;
    }
