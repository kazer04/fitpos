 ...
 * TCiTypeCarte
 *
 * @ORM\Table(name="t_ci_type_carte", indexes={@ORM\Index(name="t_ci_type_carte_fk", columns={"lg_CI_CARTE_ID"})})
 * @ORM\Entity
 */
class TCiTypeCarte
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_CI_TYPE_CARTE_ID", type="string", length=50, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgCiTypeCarteId;
     ...
     * @var \TCiCarte
     *
     * @ORM\ManyToOne(targetEntity="TCiCarte")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="lg_CI_CARTE_ID", referencedColumnName="lg_CI_CARTE_ID")
     * })
     */
    private $lgCiCarte;

    public function getLgCiTypeCarteId(): ?string
    {
        return $this->lgCiTypeCarteId;
    }
    ...
    public function getLgCiCarte(): ?TCiCarte
    {
        return $this->lgCiCarte;
    }

    public function setLgCiCarte(?TCiCarte $lgCiCarte): self
    {
        $this->lgCiCarte = $lgCiCarte;
