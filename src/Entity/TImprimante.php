...
class TImprimante
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_IMPRIMANTE_ID", type="string", length=40, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgImprimanteId;
    ...
    public function getLgImprimanteId(): ?string
    {
        return $this->lgImprimanteId;
    }
