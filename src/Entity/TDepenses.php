 ...
 * TDepenses
 *
 * @ORM\Table(name="t_depenses", indexes={@ORM\Index(name="lg_TYPE_DEPENSE_ID", columns={"lg_TYPE_DEPENSE_ID"})})
 * @ORM\Entity
 */
class TDepenses
{
     ...
     * @var string
     *
     * @ORM\Column(name="ID_DEPENSE", type="string", length=40, nullable=false)
     * @ORM\Id
     ...
     * @var \TTypeDepense
     *
     * @ORM\ManyToOne(targetEntity="TTypeDepense")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="lg_TYPE_DEPENSE_ID", referencedColumnName="lg_TYPE_DEPENSE_ID")
     * })
     */
    private $lgTypeDepense;

    public function getIdDepense(): ?string
    {
    ...
    public function getLgTypeDepense(): ?TTypeDepense
    {
        return $this->lgTypeDepense;
    }

    public function setLgTypeDepense(?TTypeDepense $lgTypeDepense): self
    {
        $this->lgTypeDepense = $lgTypeDepense;
