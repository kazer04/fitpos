 ...
 * TServices
 *
 * @ORM\Table(name="t_services", uniqueConstraints={@ORM\UniqueConstraint(name="lg_SERVICES_ID", columns={"lg_SERVICES_ID"})})
 * @ORM\Entity
 */
class TServices
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_SERVICES_ID", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgServicesId;
    ...
    public function getLgServicesId(): ?string
    {
        return $this->lgServicesId;
    }
