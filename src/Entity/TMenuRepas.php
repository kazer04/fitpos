 ...
 * TMenuRepas
 *
 * @ORM\Table(name="t_menu_repas", uniqueConstraints={@ORM\UniqueConstraint(name="lg_MENU_REPAS_ID", columns={"lg_MENU_REPAS_ID"})}, indexes={@ORM\Index(name="lg_JOUR_SEMAINE_ID", columns={"lg_JOUR_SEMAINE_ID"})})
 * @ORM\Entity
 */
class TMenuRepas
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_MENU_REPAS_ID", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgMenuRepasId;
     ...
     * @var \TJourSemaine
     *
     * @ORM\ManyToOne(targetEntity="TJourSemaine")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="lg_JOUR_SEMAINE_ID", referencedColumnName="lg_JOUR_SEMAINE_ID")
     * })
     */
    private $lgJourSemaine;

    public function getLgMenuRepasId(): ?string
    {
        return $this->lgMenuRepasId;
    }
    ...
    public function getLgJourSemaine(): ?TJourSemaine
    {
        return $this->lgJourSemaine;
    }

    public function setLgJourSemaine(?TJourSemaine $lgJourSemaine): self
    {
        $this->lgJourSemaine = $lgJourSemaine;
