 ...
 * TCiPlat
 *
 * @ORM\Table(name="t_ci_plat", indexes={@ORM\Index(name="lg_CI_TYPE_CARTE_ID", columns={"lg_CI_TYPE_CARTE_ID"})})
 * @ORM\Entity
 */
class TCiPlat
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_CI_PLAT_ID", type="string", length=50, nullable=false)
     * @ORM\Id
     ...
     * @var integer
     *
     * @ORM\Column(name="int_PRIX", type="integer", nullable=true)
     */
    private $intPrix = '0';
     ...
     * @var \TCiTypeCarte
     *
     * @ORM\ManyToOne(targetEntity="TCiTypeCarte")
     * @ORM\JoinColumns({
     *   @ORM\JoinColumn(name="lg_CI_TYPE_CARTE_ID", referencedColumnName="lg_CI_TYPE_CARTE_ID")
     * })
     */
    private $lgCiTypeCarte;

    public function getLgCiPlatId(): ?string
    {
        return $this->lgCiPlatId;
    }
    ...
    public function getIntPrix(): ?int
    {
        return $this->intPrix;
    }

    public function setIntPrix(?int $intPrix): self
    {
        $this->intPrix = $intPrix;

        return $this;
    }

    public function getLgCiTypeCarte(): ?TCiTypeCarte
    {
        return $this->lgCiTypeCarte;
    }

    public function setLgCiTypeCarte(?TCiTypeCarte $lgCiTypeCarte): self
    {
        $this->lgCiTypeCarte = $lgCiTypeCarte;
