 ...
 * TBatiment
 *
 * @ORM\Table(name="t_batiment", uniqueConstraints={@ORM\UniqueConstraint(name="lg_BATIMENT_ID", columns={"lg_BATIMENT_ID"})})
 * @ORM\Entity
 */
class TBatiment
{
     ...
     * @var string
     *
     * @ORM\Column(name="lg_BATIMENT_ID", type="string", length=30, nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="IDENTITY")
     */
    private $lgBatimentId;
    ...
    public function getLgBatimentId(): ?string
    {
        return $this->lgBatimentId;
    }
